...
class Truck:
    ...
    def __init__(self, packages, speed, mileage, address, departureTime):
...
truck1 = Truck([1, 13, 14, 15, 16, 19, 20, 21, 29, 30, 34, 40], 18, 0, "4001 South 700 East", datetime.timedelta(hours=8))

# truck 2 depart @ 10:20 AM. After 9's corrected address, all remaining EOD packages
truck2 = Truck([3, 8, 9, 12, 17, 18, 22, 23, 24, 27, 35, 36, 38, 39], 18, 0, "4001 South 700 East", datetime.timedelta(hours=10, minutes=20))

# truck 3 depart @ 9:05 AM, after late items arrive
truck3 = Truck([2, 4, 5, 6, 7, 10, 11, 25, 26, 28, 31, 32, 33, 37], 18, 0, "4001 South 700 East", datetime.timedelta(hours=9, minutes=5))
